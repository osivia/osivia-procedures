...
<form:form modelAttribute="form" action="${editListUrl}" method="post" cssClass="form-horizontal" role="form">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="<c:if test="${empty activeTab or 'form' ne activeTab}">active</c:if>"><a href="#Général" role="tab" data-toggle="tab" class="no-ajax-link">Général</a></li>
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane <c:if test="${empty activeTab or 'form' ne activeTab}">active</c:if>" id="Général">
